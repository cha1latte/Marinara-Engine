...
import { parseSpeakerTags } from "../../../../shared/lib/speaker-tags";
...
function parseConversationSpeakerTags(content: string, knownNames: Set<string>): SpeakerSegment[] | null {
  ...
  for (const segment of parsed) {
    ...
    const knownSpeaker = knownNames.has(segment.name.toLowerCase());
    segments.push({ speaker: knownSpeaker ? segment.name : null, text });
  }
